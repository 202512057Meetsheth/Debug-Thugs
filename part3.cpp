// Cyber-Neon Snake - Part 3
// Added: Movement logic, fruit spawn, score, and growth
//execution commands:
//g++ part3.cpp -o part3
//chcp 65001
//.\part3.exe
...
private:
    ...
    void placeFruit() {
        ...
        while (true) {
            fruit.p = { dr(rng), dc(rng) };
            bool onSnake = false;
            for (auto &s : snake)
                if (s.r == fruit.p.r && s.c == fruit.p.c) { onSnake = true; break; }
            if (!onSnake) break;
        }
    }
    ...
    void draw() {
        ...
        cout << "\x1b[38;2;255;120;120m●\x1b[0m";
        ...
        cout << "\x1b[38;2;200;120;255mScore: " << score << "\x1b[0m";
        T::flush();
    }
